...
<body>
    ...
    //on vas mettre dans le while une valeur au hasard de notre tableau avec array_rand
    //https://www.php.net/manual/en/function.array-rand.php

    /*création d'une fonction utilisateur nommée nombreTableauhasard qui a besoin d'un tableau en paramètre ($value)
    */
    function nombreTableauHasard(array $value){
        // création d'une variable locale qui vas contenir une valeur du tableau au hasard 
        $nombre = array_rand($value);
        //si cette valeur vaut 0 (pour notre while -> fin de la boucle)
        if ($nombre==0){
            //on envoie false
            return false;
            //sinon
